...
var artoolkitXjs = (
function(artoolkitXjs) {
  artoolkitXjs = artoolkitXjs || {};
...
var Module = typeof artoolkitXjs !== 'undefined' ? artoolkitXjs : {};
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5287168,
    DYNAMIC_BASE = 5287168,
    DYNAMICTOP_PTR = 44256;
...
var wasmBinaryFile = 'artoolkitx.wasm';
...
var ASM_CONSTS = [function($0, $1, $2, $3, $4, $5, $6) { if (!artoolkitXjs["videoMalloc"]) { artoolkitXjs["videoMalloc"] = ({}); } var videoMalloc = artoolkitXjs["videoMalloc"]; videoMalloc["framepointer"] = $0; videoMalloc["framesize"] = $1; videoMalloc["lumaFramePointer"] = $2; videoMalloc["newFrameBoolPtr"] = $3; videoMalloc["fillFlagIntPtr"] = $4; videoMalloc["timeSecPtr"] = $5; videoMalloc["timeMilliSecPtr"] = $6; }];
...
// {{PRE_LIBRARY}}
  ...
  function _jpeg_CreateDecompress() {
  err('missing function: jpeg_CreateDecompress'); abort(-1);
  }

  function _jpeg_destroy_decompress() {
  err('missing function: jpeg_destroy_decompress'); abort(-1);
  }

  function _jpeg_finish_decompress() {
  err('missing function: jpeg_finish_decompress'); abort(-1);
  }

  function _jpeg_read_header() {
  err('missing function: jpeg_read_header'); abort(-1);
  }

  function _jpeg_read_scanlines() {
  err('missing function: jpeg_read_scanlines'); abort(-1);
  }

  function _jpeg_start_decompress() {
  err('missing function: jpeg_start_decompress'); abort(-1);
  }

  function _jpeg_std_error() {
  err('missing function: jpeg_std_error'); abort(-1);
  }

  function _jpeg_stdio_src() {
  err('missing function: jpeg_stdio_src'); abort(-1);
  }
...
var asmLibraryArg = {
  ...
  "_jpeg_CreateDecompress": _jpeg_CreateDecompress,
  "_jpeg_destroy_decompress": _jpeg_destroy_decompress,
  "_jpeg_finish_decompress": _jpeg_finish_decompress,
  "_jpeg_read_header": _jpeg_read_header,
  "_jpeg_read_scanlines": _jpeg_read_scanlines,
  "_jpeg_start_decompress": _jpeg_start_decompress,
  "_jpeg_std_error": _jpeg_std_error,
  "_jpeg_stdio_src": _jpeg_stdio_src,
...
var real__arwCapture = asm["_arwCapture"]; asm["_arwCapture"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__arwCapture.apply(null, arguments);
};

var real__arwGetProjectionMatrix = asm["_arwGetProjectionMatrix"]; asm["_arwGetProjectionMatrix"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__arwGetProjectionMatrix.apply(null, arguments);
};

var real__arwGetTrackablePatternConfig = asm["_arwGetTrackablePatternConfig"]; asm["_arwGetTrackablePatternConfig"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__arwGetTrackablePatternConfig.apply(null, arguments);
};

var real__arwGetTrackablePatternImage = asm["_arwGetTrackablePatternImage"]; asm["_arwGetTrackablePatternImage"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__arwGetTrackablePatternImage.apply(null, arguments);
};

var real__arwLoadOpticalParams = asm["_arwLoadOpticalParams"]; asm["_arwLoadOpticalParams"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__arwLoadOpticalParams.apply(null, arguments);
};

var real__arwQueryTrackableVisibilityAndTransformation = asm["_arwQueryTrackableVisibilityAndTransformation"]; asm["_arwQueryTrackableVisibilityAndTransformation"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__arwQueryTrackableVisibilityAndTransformation.apply(null, arguments);
};

var real__arwUpdateAR = asm["_arwUpdateAR"]; asm["_arwUpdateAR"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__arwUpdateAR.apply(null, arguments);
};
...
var _arwCapture = Module["_arwCapture"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_arwCapture"].apply(null, arguments) };
var _arwGetProjectionMatrix = Module["_arwGetProjectionMatrix"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_arwGetProjectionMatrix"].apply(null, arguments) };
var _arwGetTrackablePatternConfig = Module["_arwGetTrackablePatternConfig"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_arwGetTrackablePatternConfig"].apply(null, arguments) };
var _arwGetTrackablePatternImage = Module["_arwGetTrackablePatternImage"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_arwGetTrackablePatternImage"].apply(null, arguments) };
var _arwLoadOpticalParams = Module["_arwLoadOpticalParams"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_arwLoadOpticalParams"].apply(null, arguments) };
var _arwQueryTrackableVisibilityAndTransformation = Module["_arwQueryTrackableVisibilityAndTransformation"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_arwQueryTrackableVisibilityAndTransformation"].apply(null, arguments) };
var _arwUpdateAR = Module["_arwUpdateAR"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_arwUpdateAR"].apply(null, arguments) };
...
)(typeof artoolkitXjs === 'object' ? artoolkitXjs : {});
export default artoolkitXjs;